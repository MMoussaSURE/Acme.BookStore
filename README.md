...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 300b8c2b-c5e0-4cf6-8aa9-0bd48af55e67
```

> `300b8c2b-c5e0-4cf6-8aa9-0bd48af55e67` is the password of the certificate, you can change it to any password you want.
