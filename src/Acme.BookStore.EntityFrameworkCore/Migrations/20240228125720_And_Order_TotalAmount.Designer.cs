...
namespace Acme.BookStore.Migrations
{
    ...
    [Migration("20240228125720_And_Order_TotalAmount")]
    partial class And_Order_TotalAmount
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Acme.BookStore.Clients.Client", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("BusinessAddress", "Acme.BookStore.Clients.Client.BusinessAddress#Address", b1 =>
                        {
                            b1.IsRequired();
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("HomeAddress", "Acme.BookStore.Clients.Client.HomeAddress#Address", b1 =>
                        {
                            b1.IsRequired();
            ...
            modelBuilder.Entity("Acme.BookStore.Orders.OrderLine", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Acme.BookStore.Orders.Order", b =>
                {
                    b.HasOne("Acme.BookStore.Clients.Client", "Client")
                        .WithMany()
            ...
            modelBuilder.Entity("Acme.BookStore.Orders.OrderLine", b =>
                {
                    ...
                    b.HasOne("Acme.BookStore.Products.Product", "Product")
                        .WithMany()
